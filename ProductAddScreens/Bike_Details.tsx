...
const bikeData: BikeBrand[] = require("../JSON/BikeBrandAndModel.json");
import AntDesign from '@expo/vector-icons/AntDesign';

const SCREEN_HEIGHT = Dimensions.get("window").height;
const SCREEN_WIDTH = Dimensions.get("window").width;

export default function Bike_Details({  }) {
  ...
  const handleImagePick = async () => {
    ...
    launchImageLibrary({ mediaType: "photo" }, (response) => {
      if (response.assets && response.assets.length > 0) {
        setBikeImage(response.assets[0].uri);
      }
    });
  };
  const isFormValid =
  ...
  const filteredBrands = bikeData.filter((item) =>
      ...
      <SafeAreaView>
        <ScrollView>
          <View style={styles.viewBox}>
            ...
            <Button title="Choose Bike Photo" onPress={handleImagePick} />
          </View>
          <View style={styles.viewBox}>
          ...
          <Modal visible={modalVisible} animationType="slide">
            <SafeAreaView style={styles.modalContainer}>
              <Text style={{
                ...
                fontWeight:'700',
                color:'#FF6347'
              }}>Please select your Bike brand</Text>
              <TextInput
  ...
  <Text style={styles.closeButtonText}>Next</Text>
          ...
          <Modal visible={modelSelectionVisible} animationType="slide">
            ...
            <Text style={{
                ...
                fontWeight:'700',
                color:'#FF6347'
              }}>Please select your Bike Model</Text>
              <TextInput
